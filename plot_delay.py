...
if experimentXAxis == "Nodes":
    ...
    file_path = 'results/avg/avg_delayExp_cl' + fileExtName + '.txt'
    ...
    plt.savefig("results/avg/avg_delay_vs_nodes_cl" + fileExtName + ".png", format='png', dpi=300)
    ...
    # File path for the delay experiment data
    file_path = 'results/avg/avg_delayExpBt_cl' + fileExtName + '.txt'
    ...
    # Save the plot as an image file
    plt.savefig("results/avg/avg_delay_vs_batch_size_cl" + fileExtName + ".png", format='png', dpi=300)
